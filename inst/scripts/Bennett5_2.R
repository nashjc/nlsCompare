...
NLSpars<-as.numeric(subset(NLSproblems,Name=="Bennett5_2.R")[4:(4+subset(NLSproblems,Name=="Bennett5_2.R")$nPars-1)])
NLSssquares<-subset(NLSproblems,Name=="Bennett5_2.R")$ssquares
NLStag<-"unbounded"
# NLSproblems[NLSproblems[,"Name"]=="Bennett5_2.R",]$PkgVers<-paste(NLSref,NLSrefVersion,sep=":")
# NLSproblems[NLSproblems[,"Name"]=="Bennett5_2.R",]$LastUpdated<-format(Sys.time(), "%Y-%m-%d %H:%M")
